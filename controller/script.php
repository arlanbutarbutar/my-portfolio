...
if(isset($_POST['contact-submit'])){
              ...
              <tr>
                  ...
                  <div class='header' style='padding: 20px 0;'>
                      ...
                      <tr>
                          ...
                          <a href='https://www.net-code.tech' style='color: #000; text-decoration: underline;'><img src='https://i.ibb.co/hDqFwPr/NET-Code-logo.png' height='100' alt='Postdrop' style='border: none; -ms-interpolation-mode: bicubic; max-width: 100%;'></a>
                          <p style='font-family: sans-serif; font-weight: normal; margin: 0; margin-bottom: 15px; text-decoration: none; color: #fff; font-size: 20px;'>Netmedia Framecode</p>
                          </td>
                      </tr>
                      </table>
                  </div>
                  <div class='content' style='box-sizing: border-box; display: block; margin: 0 auto; max-width: 580px; padding: 10px;'>
                      ...
                      <tr>
                          ...
                          <table role='presentation' border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;' width='100%'>
                              ...
                              <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;' valign='top'>
                                  <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;'>Hai ar.code_,</p>
                                  <p style='font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;'>Pesan masuk dari pengunjung dengan pesan sebagai berikut: <br> ".$message." <br> Dikirim oleh ".$name."<br>email: ".$email."</p>
                                  <p style='font-family: sans-serif; font-size: 14px; font-weight: normal;margin-top: 25px;'>Salam Hormat, <br> Dukungan Komunikasi <br> Netmedia Framecode</p>
                      ...
                      <table role='presentation' border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; width: 100%;' width='100%'>
                          ...
                          <td class='content-block powered-by' style='font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #9a9ea6; font-size: 12px; text-align: center;' valign='top' align='center'>
                              Powered by <a href='https://www.net-code.tech' style='color: #9a9ea6; font-size: 12px; text-align: center; text-decoration: none;'>Netmedia Framecode</a>.
                          </td>
                          </tr>
                      </table>
                      </div>
  ...
  $_SESSION['message-success']="Terkirim";
